...
<head>
    <meta charset="UTF-8">
    <title>Online Order - Sup Tulang ZZ</title>
    ...
    <style>
        * {
        ...
        .delivery-info {
            ...
            font-weight: 500;
            border-radius: 12px;
            box-shadow: 0 2px 12px rgba(180, 205, 186, 0.3);
        }
        ...
        .track-order-section .form-input {
            flex: 1 1 120px;
            padding: 12px 16px;
...
<div class="container">
    <div class="header">
        <h1><i class="fas fa-laptop icon"></i>Sup Tulang ZZ Online</h1>
        <p>Authentic Malaysian Flavors Delivered to Your Door</p>
        <div style="display: flex; align-items: center; justify-content: center; gap: 18px; flex-wrap: wrap;">
            <div class="online-badge">
                <i class="fas fa-truck"></i>
                Online Ordering
            </div>
            <form action="online_order_success.php" method="get" style="display: flex; align-items: center; gap: 8px;">
                <input 
                    type="number" 
                    name="oid" 
                    class="form-input" 
                    ...
                    required 
                    style="padding: 10px 14px; border: 2px solid #f0f0f0; border-radius: 8px; font-size: 1em; width: 120px;"
                >
                <button 
                    type="submit" 
                    class="add-to-cart-btn" 
                    style="padding: 10px 18px; font-size: 1em; display: flex; align-items: center; gap: 6px;"
                >
        ...
        <div style="font-size: 0.95em; color: #888; margin-top: 6px;">
            <span>*Find your Order ID on your receipt or confirmation page.</span>
        </div>
    </div>

    <div class="delivery-info">
        <i class="fas fa-info-circle"></i> 
        Free delivery within 5km radius • Minimum order RM20 • Estimated delivery: 30-45 minutes
    </div>
    ...
    $menuGroups = [
        ...
        "Set Menu" => ["Set Nasi & Lauk"],
        "Sarapan" => ["Sarapan"],
        "Roti" => ["Roti Bakar", "Roti Canai"],
        "Seafood" => ["Ikan Siakap & Bakar-Bakar", "Menu Ikan"],
        "Thai Food" => ["Aneka Lauk Thai", "Sup Ala Thai", "Tomyam"],
        "Western Food" => ["Western Food", "Spaghetti"],
        "Local Favorites" => ["Goreng-Goreng", "Mee Kuah"],
        "Snacks" => ["Burger", "Sides", "Goreng Tepung"],
        "Drinks" => ["Drinks"]
    ];
                            ...
                            <div class="menu-item-card">
                                <div class="menu-item-content">
                                    ...
                                    <div class="menu-item-details">
                                        ...
                                        <form action="add_to_online_cart.php" method="POST">
                                            ...
                                            <div class="order-form">
                                                <div>
                                                    ...
                                                    <input type="number" name="quantity" value="1" min="1" max="10" id="qty_<?= $row['id'] ?>">
                                                </div>
