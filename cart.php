...
session_start();
$cart = $_SESSION['cart'] ?? [];
$table_number = $_SESSION['table_number'] ?? null; // Get stored table number
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .cart-item-content { flex-direction: column; gap: 16px; }
            .cart-item-header { flex-direction: column; align-items: flex-start; gap: 12px; }
...
<div class="container">
    <div class="header">
        ...
        <p>Review your order and proceed to confirm</p>
        
        <!-- Add table number indicator in cart -->
        <?php if ($table_number): ?>
    ...
    <?php else: ?>
        ...
        <div class="checkout-section">
            <div class="section-title">
                ...
                <?= $table_number ? 'Confirm Order' : 'Table Number' ?>
            </div>
            <form action="submit_order.php" method="POST">
                <?php if ($table_number): ?>
                    <!-- Auto-filled table number -->
                    <div class="form-group">
                        <label class="form-label">
                            <i class="fas fa-table"></i> Table Number
                        </label>
                        <div style="background: #f8f9fa; padding: 12px 16px; border-radius: 8px; border: 2px solid #e9ecef; display: flex; align-items: center; gap: 10px;">
                            <i class="fas fa-check-circle" style="color: #28a745;"></i>
                            <span style="font-weight: 600; color: #2E2E2E;">Table <?= $table_number ?></span>
                            <span style="color: #666; font-size: 0.875rem; margin-left: auto;">(Auto-detected from QR scan)</span>
                        </div>
                ...
                <?php else: ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="table_number" id="table_number" class="form-input" required min="1" placeholder="Table #">
                    </div>
                <?php endif; ?>
                
                <button type="submit" class="order-btn">
                    <i class="fas fa-check-circle"></i>
                    Confirm Order • RM<?= number_format($grand_total, 2) ?>
                </button>
            </form>
        </div>
        <div class="action-buttons">
            ...
            <a href="clear_cart.php" class="btn btn-outline" onclick="return confirm('Are you sure you want to clear your cart?')">
...
<script>
    // Enhanced loading animation with classic feel
